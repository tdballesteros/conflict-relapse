...
gdppc <- dplyr::full_join(gdp, pd, by = c("iso3c", "year"))
...
gdppc.plus1 <- gdppc %>%
  ...
  dplyr::rename(
    gdppc.pwt.un.plus1 = gdppc.pwt.un,
...
# gdppc.pwt.un
### An estimate for gross domestic product per capita using estimates for GDP and population built
### off of Penn World Tables and United Nations data, respectively.
# gdppc.pwt.cow
### An estimate for gross domestic product per capita using estimates for GDP and population built
### off of Penn World Tables and Correlates of War data, respectively.
# gdppc.gl.un
### An estimate for gross domestic product per capita using estimates for GDP and population built
### off of Gleditsch and United Nations data, respectively.
# gdppc.gl.cow
### An estimate for gross domestic product per capita using estimates for GDP and population built
### off of Gleditsch and Correlates of War data, respectively.

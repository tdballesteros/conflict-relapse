...
# SYR: 1946 independence from France; 1961 dissolution of the United Arab Republic [UAR is coded as Egypt]
...
# recode GBR's 1816 independence date with 1801 - the Acts of Union 1800's entrance into effect uniting Great
...
# recode TUR's 1816 independence date with 1923 - establishment of republic Turkey
...
# SYR: Syria regained independence after leaving the United Arab Republic in 1961; Syria is coded as independent
# throughout the UAR's life, but for purposes of independence dates, code as initial year of independence from
# France (1946) for pre-UAR and during UAR, whereas code as 1961 after the UAR
cyears2$styear[cyears2$iso3c=="SYR"&cyears2$year>=1961] <- 1961
# EGY: Egypt reverted back to independence following Syria's withdrawal from the United Arab Republic in 1961;
# Egypt is coded as indepdendent throughout the UAR's life, but for purposes of independence dates, code as initial
# year of independence from the UK (1937) for pre-UAR and during UAR, whereas code as 1961 after the UAR
cyears2$styear[cyears2$iso3c=="EGY"&cyears2$year>=1961] <- 1961

# calculate years since independence
cyears2 <- cyears2 %>%
  dplyr::mutate(yrs_since_indep = year - styear,
                # if the country did not exist yet (indicated by negative yrs_since_indep value), replace
                # yrs_since_indep with 0

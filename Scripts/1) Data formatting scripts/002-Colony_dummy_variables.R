...
# This script takes an Excel spreadsheet coding each country into dummy variables relating to
# colonialism.

# The main "colony" dummy variable codes countries that were previously colonies (not parts of
# empries, such as parts of Ottoman or Russian/Soviet countries).

# Additional dummy variables are coded for whether a country was a colony of a given empire:
# the United Kingdom (GBR), France (FRA), Spain (ESP), Portugal (PRT), Netherlands (NLD), Italy
# (ITA), Belgium (BEL), the United States (USA), or other countries (e.g., Australia, New Zealand).
# The code is for the last colonial power to control the territory; for example, the Philippines is
# coded as an American colony, as the United States was the last country to administer the territory
# prior to its independence, despite Spain also controling the territory prior to the United States.
...
### North Yemen, South Yemen, South Vietnam, the Netherlands Antilles, the Soviet Union, Yugoslavia,
### and Zanzibar.
# country
### A country's commonly used English-language name.
## colony
### A dummy variable coding whether the country was a colony of a European/other Western country in
### its history.
## colony_gbr
### A dummy variable coding whether the last colonial power prior to independence was the United
### Kingdom.
## colony_fra
...
## colony_nld
### A dummy variable coding whether the last colonial power prior to independence was the
### Netherlands.
## colony_ita
...
### States
## colony_other
### A dummy variable coding whether the last colonial power prior to independence was another
### Western country or a special arrangement of colonial powers.
## colonizer
### A variable specifying if the country was a colony of the United Kingdom, France, Spain,
### Portugal, another country, or not colonized.
